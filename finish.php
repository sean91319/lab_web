...
<?php
	...
	setcookie("user", $Nickname, time()+3600)or die('unable to create cookie');
	// ob_start();
	// setcookie("user", "31312", time()+3600)or die('unable to create cookie');
	// echo $_COOKIE['user'];


	$sql="INSERT INTO person (Name, Nickname, Email, Password, Company, Position, Phone, Rand_Num, isConfirm, Firstlogin) VALUES('$Name','$Nickname', '$Email', '$Password', '$Company', '$Position', '$Phone', '$randnum', '$isConfirm', '$Firstlogin')";
